...
export const Menu = (props: Props) => (
	<svg onClick={props.onClick} width='40px' height='40px' viewBox='0 0 48 48' fill='none' xmlns='http://www.w3.org/2000/svg'>
		<rect width='48' height='48' fill='white' fillOpacity='0.01' />
		<path d='M7.94977 11.9498H39.9498' stroke='#FF6400' strokeWidth='4' strokeLinecap='round' strokeLinejoin='round' />
		<path d='M7.94977 23.9498H39.9498' stroke='#FF6400' strokeWidth='4' strokeLinecap='round' strokeLinejoin='round' />
		<path d='M7.94977 35.9498H39.9498' stroke='#FF6400' strokeWidth='4' strokeLinecap='round' strokeLinejoin='round' />
	</svg>
);
...
export const User = () => (
	...
	>
		<g>
			<g>
				<path
					d='M30.061,18.237c2.127-1.916,3.476-4.683,3.476-7.772C33.536,4.684,28.85,0,23.07,0C17.29,0,12.604,4.685,12.604,10.465
...
export const Logo = () => (
	<svg
		...
		x='0px'
		y='0px'
		viewBox='0 0 595.3 238.9'
	>
		<g>
			<g>
				<path className='st0' d='M125.3,88.7H12.7l20.4,48.5C45.5,130.7,113.8,94.1,125.3,88.7z' />
				<path
					className='st0'
					d='M126.7,88.7c-3.3,8.5-40.3,99.2-40.3,99.2l-2.6-52.2l-50.4,2.4l38.7,92.2h36l59.5-141.7L126.7,88.7
			L126.7,88.7z'
				/>
			</g>
			<rect x='183.1' y='88.7' className='st0' width='36.8' height='141.6' />
			<polygon
				className='st0'
				points='503.4,230.3 538.9,230.3 584.3,88.7 548.2,88.7 520.6,183.2 496.5,88.7 460.9,88.7 436,183.2 
		409,88.7 373.3,88.7 418,230.3 454.1,230.3 478.5,137.6 	'
			/>
			<path
				className='st0'
				d='M353.9,106.4C341.8,92.6,325,85.5,304,85.5c-18.6,0-34.2,6.7-46.5,19.9c-12.2,13.2-18.3,31.8-18.3,55.1
		...
		<g>
			<path
				className='st0'
				d='M13.3,33.1h10.4v5.5c1.6-3.1,3.8-4.7,4.6-5.1c1.6-1,3.7-1.6,6.1-1.6c1.8,0,3.2,0.4,4.4,0.8l-1.4,9.7
		C36,41.5,34.7,41,32.6,41c-2,0-4.8,0.4-6.9,3c-2,2.5-2,5.6-2,8.1v17.7H13.3V33.1z'
			/>
			<path
				className='st0'
				d='M79,59.6c-1.1,2.7-5.3,11.5-18.1,11.5c-5.9,0-10.4-1.7-14.1-5.2c-4.1-3.8-5.8-8.6-5.8-14.3
		...
		c1.1,1.5,3.4,3.5,7.4,3.5c3.9,0,6.9-1.9,8.6-4.8L79,59.6z M69.5,46.6c-0.8-5-4.9-7.4-8.7-7.4s-7.8,2.5-8.7,7.4H69.5z'
			...
			<path
				className='st0'
				d='M116.3,33.1h10.4v36.8h-10.4v-4.8c-3.7,5.3-8.7,5.9-11.3,5.9c-11.3,0-18.8-8.8-18.8-19.6
		...
		c0-5.9-4.2-10.4-10.2-10.4C101.2,41.1,96.9,45.6,96.9,51.5z'
			/>
			<path className='st0' d='M146,8v61.9h-10.4V8H146z' />
			<path
				className='st0'
				d='M192.8,59.6c-1.1,2.7-5.3,11.5-18.1,11.5c-5.9,0-10.4-1.7-14.1-5.2c-4.1-3.8-5.8-8.6-5.8-14.3
		...
		c1.1,1.5,3.4,3.5,7.4,3.5c3.9,0,6.9-1.9,8.6-4.8L192.8,59.6z M183.2,46.6c-0.8-5-4.9-7.4-8.7-7.4s-7.8,2.5-8.7,7.4H183.2z'
			...
			<path
				className='st0'
				d='M222.6,41.9c-2.5-2.3-4.9-2.5-6-2.5c-2.5,0-4,1.2-4,3c0,0.9,0.4,2.4,3.3,3.3l2.5,0.8c2.9,0.9,7.2,2.4,9.3,5.3
		...
		c2.9-2.3,6.6-2.6,9.6-2.6c2.7,0,7,0.3,11.7,3.9L222.6,41.9z'
			/>
			<path className='st0' d='M248.1,42v27.9h-10.4V42h-4.1v-8.8h4.1V20.6h10.4v12.6h7.1V42H248.1z' />
			<path
				className='st0'
				d='M289.6,33.1H300v36.8h-10.4v-4.8c-3.7,5.3-8.7,5.9-11.3,5.9c-11.3,0-18.8-8.8-18.8-19.6
		...
		c5.9,0,10.2-4.6,10.2-10.4c0-5.9-4.2-10.4-10.2-10.4S270.3,45.6,270.3,51.5z'
			/>
			<path className='st0' d='M321.1,42v27.9h-10.4V42h-4.1v-8.8h4.1V20.6h10.4v12.6h7.1V42H321.1z' />
			<path
				className='st0'
				d='M370.5,59.6c-1.1,2.7-5.3,11.5-18.1,11.5c-5.9,0-10.4-1.7-14.1-5.2c-4.1-3.8-5.8-8.6-5.8-14.3
		c0-7.3,3-11.8,5.6-14.4c4.3-4.2,9.4-5.2,13.8-5.2c7.5,0,11.8,3,14.3,6c3.9,4.7,4.4,10.4,4.4,14.4v0.8h-27.5c0,2.2,0.6,4.6,1.8,6.2
